...
void setup() {
 ...
 TXBuf[0] = 0xa5;    //Sync 0								--> 165
 TXBuf[1] = 0x5a;    //Sync 1								--> 90
 TXBuf[2] = 0;       //Packet counter High Byte
 TXBuf[3] = 0;       //Packet counter Low Byte
 TXBuf[4] = 0x00;    //CH1 High Byte
 TXBuf[5] = 0x00;    //CH1 Low Byte
 TXBuf[2 * NUMCHANNELS + HEADERLEN] =  0x01;	// Switches state   in fact this is TXBuf[6]		--> 1
...
void Timer2_Overflow_ISR()
{
  ...
  //Read the 6 ADC inputs and store current values in Packet
    ...
    TXBuf[((2*0) + HEADERLEN)] = ((unsigned char)((ADC_Value & 0xFF00) >> 8));	// Write High Byte
    TXBuf[((2*0) + HEADERLEN + 1)] = ((unsigned char)(ADC_Value & 0x00FF));	// Write Low Byte
  ...
  TXBuf[ 3 ] = ((unsigned char)(CNTR_1 & 0x00FF)); // Write Low Byte
